...
const QIAN = TRIGRAMS[0]
const DUI = TRIGRAMS[1]
const LI = TRIGRAMS[2]
const ZHEN = TRIGRAMS[3]
const XUN = TRIGRAMS[4]
const KAN = TRIGRAMS[5]
const GEN = TRIGRAMS[6]
const KUN = TRIGRAMS[7]
...
const HEXAGRAM_INTERPRETATIONS: Record<number, string> = {
